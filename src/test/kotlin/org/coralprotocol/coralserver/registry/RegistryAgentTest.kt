...
class RegistryAgentTest : CoralTest({
    ...
    fun testOptions(agent: RegistryAgent) {
        val fullStringOption =
            agent.options["FULL_STRING_OPTION"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.String>()
        ...
        defaultI8.shouldBeInstanceOf<PolymorphicAgentOption.Byte>().default.shouldNotBeNull()
            .shouldBeEqual(-42)

        val defaultI16 = agent.options["DEFAULT_I16"].shouldNotBeNull()
        defaultI16.shouldBeInstanceOf<PolymorphicAgentOption.Short>().default.shouldNotBeNull()
            .shouldBeEqual(1024)

        val defaultI32 = agent.options["DEFAULT_I32"].shouldNotBeNull()
        defaultI32.shouldBeInstanceOf<PolymorphicAgentOption.Int>().default.shouldNotBeNull()
            .shouldBeEqual(123456)

        val defaultI64 = agent.options["DEFAULT_I64"].shouldNotBeNull()
        defaultI64.shouldBeInstanceOf<PolymorphicAgentOption.Long>().default.shouldNotBeNull()
            .shouldBeEqual(9876543210L)

        val defaultU8 = agent.options["DEFAULT_U8"].shouldNotBeNull()
        defaultU8.shouldBeInstanceOf<PolymorphicAgentOption.UByte>().default.shouldNotBeNull()
            .shouldBeEqual(200u)

        val defaultU16 = agent.options["DEFAULT_U16"].shouldNotBeNull()
        defaultU16.shouldBeInstanceOf<PolymorphicAgentOption.UShort>().default.shouldNotBeNull()
            .shouldBeEqual(5000u)

        val defaultU32 = agent.options["DEFAULT_U32"].shouldNotBeNull()
        defaultU32.shouldBeInstanceOf<PolymorphicAgentOption.UInt>().default.shouldNotBeNull()
            .shouldBeEqual(1000000u)

        val defaultU64 = agent.options["DEFAULT_U64"].shouldNotBeNull()
        defaultU64.shouldBeInstanceOf<PolymorphicAgentOption.ULong>().default.shouldNotBeNull()
            .shouldBeEqual("18446744073709")

        val defaultF32 = agent.options["DEFAULT_F32"].shouldNotBeNull()
        defaultF32.shouldBeInstanceOf<PolymorphicAgentOption.Float>().default.shouldNotBeNull()
            .shouldBeEqual(3.14f)

        val defaultF64 = agent.options["DEFAULT_F64"].shouldNotBeNull()
        defaultF64.shouldBeInstanceOf<PolymorphicAgentOption.Double>().default.shouldNotBeNull()
            .shouldBeEqual(2.718281828)

        val defaultBool = agent.options["DEFAULT_BOOL"].shouldNotBeNull()
        defaultBool.shouldBeInstanceOf<PolymorphicAgentOption.Boolean>().default.shouldNotBeNull()
            .shouldBeEqual(true)

        val defaultString = agent.options["DEFAULT_STRING"].shouldNotBeNull()
        defaultString.shouldBeInstanceOf<PolymorphicAgentOption.String>().default.shouldNotBeNull()
            .shouldBeEqual("hello world")

        val blobText = "hello world"
        val defaultBlob =
            agent.options["DEFAULT_BLOB"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.Blob>()
        ...
        agent.options["OPTIONAL_I8"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.Byte>()
        agent.options["OPTIONAL_I16"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.Short>()
        agent.options["OPTIONAL_I32"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.Int>()
        agent.options["OPTIONAL_I64"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.Long>()
        agent.options["OPTIONAL_U8"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.UByte>()
        agent.options["OPTIONAL_U16"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.UShort>()
        agent.options["OPTIONAL_U32"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.UInt>()
        agent.options["OPTIONAL_U64"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.ULong>()
        agent.options["OPTIONAL_F32"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.Float>()
        agent.options["OPTIONAL_F64"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.Double>()
        agent.options["OPTIONAL_BOOL"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.Boolean>()
        agent.options["OPTIONAL_STRING"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.String>()
        agent.options["OPTIONAL_BLOB"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.Blob>()
        agent.options["OPTIONAL_LIST_I8"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.ByteList>()
        agent.options["OPTIONAL_LIST_I16"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.ShortList>()
        agent.options["OPTIONAL_LIST_I32"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.IntList>()
        agent.options["OPTIONAL_LIST_I64"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.LongList>()
        agent.options["OPTIONAL_LIST_U8"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.UByteList>()
        agent.options["OPTIONAL_LIST_U16"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.UShortList>()
        agent.options["OPTIONAL_LIST_U32"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.UIntList>()
        agent.options["OPTIONAL_LIST_U64"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.ULongList>()
        agent.options["OPTIONAL_LIST_F32"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.FloatList>()
        agent.options["OPTIONAL_LIST_F64"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.DoubleList>()
        agent.options["OPTIONAL_LIST_STRING"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.StringList>()
        agent.options["OPTIONAL_LIST_BLOB"].shouldNotBeNull().shouldBeInstanceOf<PolymorphicAgentOption.BlobList>()
    }
        ...
        shouldNotThrowAny {
            registryAgent("valid") {
                ...
                repeat(AGENT_OPTION_MAX_ENTRIES) { idx ->
                    option("OPT_$idx", PolymorphicAgentOption.String(default = "x"))
                }
            }.validate()
        }
    ...
    test("testValidateOptionKeyName") {
        ...
        for (key in validKeys) {
            shouldNotThrowAny {
                registryAgent("valid") {
                    runtime(FunctionRuntime())
                    option(key, PolymorphicAgentOption.String(default = "x"))
                }.validate()
            }
        }
    ...
    test("testValidateOptionDefaultsTotalSize") {
        shouldNotThrowAny {
            registryAgent("valid") {
                runtime(FunctionRuntime())
                option("OK", PolymorphicAgentOption.String(default = "a".repeat(1024)))
            }.validate()
        }
        ...
        shouldThrow<RegistryException> {
            registryAgent("valid") {
                ...
                while (budget > 0) {
                    val size = 1024
                    option("NIBBLE$budget", PolymorphicAgentOption.String(default = "a".repeat(size)))
                ...
                if (budget == 0)
                    option("OVERFLOW", PolymorphicAgentOption.String(default = "a"))
    ...
    test("testValidatePrototypeRuntimeMiscellaneous") {
        ...
        shouldNotThrowAny {
            registryAgent("valid") {
                ...
                option("EXAMPLE_PROXY_NAME", PolymorphicAgentOption.String(default = "gpt-5.1"))
            }.validate()
        }
        ...
        shouldThrow<RegistryException> {
            registryAgent("valid") {
                ...
                option("EXAMPLE_PROXY_NAME_OPTION", PolymorphicAgentOption.Int())
            }.validate()
        }
    }
    ...
    test("testValidatePrototypeStringComposed") {
        ...
        shouldNotThrowAny {
            registryAgent("valid") {
                ...
                option("API_KEY", PolymorphicAgentOption.String())
            }.validate()
        }
        ...
        shouldThrow<RegistryException> {
            registryAgent("valid") {
                ...
                option("INT_OPTION", PolymorphicAgentOption.Int())
            }.validate()
        }
    ...
    test("testDependencies") {
        ...
        shouldNotThrowAny {
            registryAgent("valid") {
                runtime(FunctionRuntime())
                option("EXISTENT_OPTION", PolymorphicAgentOption.Int())
