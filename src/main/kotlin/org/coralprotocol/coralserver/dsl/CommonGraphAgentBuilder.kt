...
class GraphAgentBuilder(name: String) : CommonGraphAgentBuilder(name) {
    ...
    fun stringListOption(name: String, value: List<String>, block: StringListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.stringListOption(name, block).option.withValue(PolymorphicAgentOptionValue.StringList(value))
    }
    ...
    fun blobListOption(name: String, value: List<String>, block: BlobListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.blobListOption(name, block).option.withValue(PolymorphicAgentOptionValue.BlobList(value))
    }
    ...
    fun byteListOption(name: String, value: List<Byte>, block: ByteListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.byteListOption(name, block).option.withValue(PolymorphicAgentOptionValue.ByteList(value))
    }
    ...
    fun shortListOption(name: String, value: List<Short>, block: ShortListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.shortListOption(name, block).option.withValue(PolymorphicAgentOptionValue.ShortList(value))
    }
    ...
    fun longListOption(name: String, value: List<Long>, block: LongListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.longListOption(name, block).option.withValue(PolymorphicAgentOptionValue.LongList(value))
    }

    fun unsignedByteOption(name: String, value: UByte, block: UByteAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.unsignedByteOption(name, block).option.withValue(PolymorphicAgentOptionValue.UByte(value))
    }

    fun unsignedByteListOption(name: String, value: List<UByte>, block: UByteListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.unsignedByteListOption(name, block).option.withValue(PolymorphicAgentOptionValue.UByteList(value))
    }

    fun unsignedShortOption(name: String, value: UShort, block: UShortAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.unsignedShortOption(name, block).option.withValue(PolymorphicAgentOptionValue.UShort(value))
    }

    fun unsignedShortListOption(name: String, value: List<UShort>, block: UShortListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.unsignedShortListOption(name, block).option.withValue(PolymorphicAgentOptionValue.UShortList(value))
    }

    fun unsignedIntOption(name: String, value: UInt, block: UIntAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.unsignedIntOption(name, block).option.withValue(PolymorphicAgentOptionValue.UInt(value))
    }

    fun unsignedIntListOption(name: String, value: List<UInt>, block: UIntListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.unsignedIntListOption(name, block).option.withValue(PolymorphicAgentOptionValue.UIntList(value))
    }

    fun unsignedLongOption(name: String, value: ULong, block: ULongAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.unsignedLongOption(name, block).option.withValue(PolymorphicAgentOptionValue.ULong(value.toString()))
    }

    fun unsignedLongListOption(name: String, value: List<ULong>, block: ULongListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.unsignedLongListOption(name, block).option.withValue(PolymorphicAgentOptionValue.ULongList(value.map { it.toString() }))
    }
    ...
    fun floatListOption(name: String, value: List<Float>, block: FloatListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.floatListOption(name, block).option.withValue(PolymorphicAgentOptionValue.FloatList(value))
    }
    ...
    fun doubleListOption(name: String, value: List<Double>, block: DoubleListAgentOptionBuilder.() -> Unit = {}) {
        options[name] =
            registryAgentBuilder.doubleListOption(name, block).option.withValue(PolymorphicAgentOptionValue.DoubleList(value))
    }
