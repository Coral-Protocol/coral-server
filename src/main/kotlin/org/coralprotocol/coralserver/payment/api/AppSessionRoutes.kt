...
import com.coral.payment.orchestration.SessionManager
import com.coral.payment.orchestration.InsufficientAgentsException
import com.coral.payment.orchestration.SessionCreationException
import com.coral.payment.orchestration.SessionFundingException
import com.coral.payment.orchestration.InsufficientFundsException
        ...
        post("/{id}/fund") {
            ...
            result.fold(
                onSuccess = { tx ->
                    ...
                    call.respond(FundSessionResponse(
                        sessionId = sessionId,
