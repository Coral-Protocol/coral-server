...
//import org.coralprotocol.coralserver.session.LocalSession2
//import org.coralprotocol.coralserver.session.Session
//import org.coralprotocol.coralserver.session.SessionAgent2
...
//            session = session,
//            agentId = registryAgent.info.identifier,
//        )
//
//        when (val provider = graphAgent.provider) {
//            is GraphAgentProvider.Local -> {
//                val runtime = registryAgent.runtimes.getById(provider.runtime)
//                    ?: throw IllegalArgumentException("The requested runtime: ${provider.runtime} is not supported on agent ${agent.name}")
//
...
//                    GraphAgentRequest(
//                        id = registryAgent.info.identifier,
//                        name = agent.name,
