...
data class DockerContainerSpec(
    ...
    val stopTimeoutSeconds: Int = 1,
)

suspend fun launchDockerContainer(
    spec: DockerContainerSpec,
    executionContext: SessionAgentExecutionContext,
    applicationRuntimeContext: ApplicationRuntimeContext,
    onLogLine: (StreamType, String) -> Unit = { _, _ -> },
    ...
    try {
        ...
        val containerCreationCmd = docker.createContainerCmd(sanitisedImageName)
            ...
            .withStopTimeout(spec.stopTimeoutSeconds)
        ...
        attachCmd.exec(object : ResultCallback.Adapter<Frame>() {
            override fun onNext(frame: Frame) {
                ...
                onLogLine(frame.streamType, message)
            }
        })
